...
Open **http://localhost:5173/** — empty garden. Create a volume (+), then **Ask Anything**.  
Tegria loads **only** `gtih-sdk.js` from the GTIH host (no Vite path proxy to GT3). COOP/COEP stay on the Tegria origin for WebContainer labor.
