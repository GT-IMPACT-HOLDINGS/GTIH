...
LENGTH CONSTRAINT:
- 3 items ideal; 5 items maximum.
- If more actions exist, merge them into broader steps or move detail into Dependencies.


FORMAT RULES (each step must include):
- Action (verb-first)
...
LENGTH CONSTRAINT:
- 3 bullets ideal; 5 bullets maximum TOTAL (across all sections).
- Combine related points; keep wording ultra-compact.
