...
function liftSharedPolicy(capsules) {
  ...
  return {
    shared_invariants: [
      'Write only the finished SUD itself — reader-facing deliverable prose, nothing else.',
      ...
      'Do not add notes, remarks, commentary, ceremonial notes, or explanations about the artifact inside document.md / sections/**.'
    ],
